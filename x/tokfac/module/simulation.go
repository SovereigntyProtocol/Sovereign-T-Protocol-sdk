...
import (
	...
	tokfacsimulation "github.com/cosmos/cosmos-sdk/x/tokfac/simulation"
	"github.com/cosmos/cosmos-sdk/x/tokfac/types"
)

// avoid unused import issue
var (
	_ = tokfacsimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	tokfacGenesis := types.GenesisState{
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&tokfacGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		tokfacsimulation.SimulateMsgCreateDenom(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		tokfacsimulation.SimulateMsgUpdateDenom(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		tokfacsimulation.SimulateMsgDeleteDenom(am.accountKeeper, am.bankKeeper, am.keeper),
	))
