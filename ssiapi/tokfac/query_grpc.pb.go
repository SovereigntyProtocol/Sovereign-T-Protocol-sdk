...
const (
	Query_Params_FullMethodName   = "/tokfac.tokfac.Query/Params"
	Query_Denom_FullMethodName    = "/tokfac.tokfac.Query/Denom"
	Query_DenomAll_FullMethodName = "/tokfac.tokfac.Query/DenomAll"
)
